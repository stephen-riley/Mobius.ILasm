...
{
    CF_IL_ONLY = 1, CF_32_BITREQUIRED = 2,
...
{
    Retargetable = 0x100, EnableJITCompileTracking = 0x8000,
...
{
    Default, Cdecl, Stdcall, Thiscall,
...
{
    nomangle = 1, ansi = 2, unicode = 4, autochar = 6,
...
{
    IL, Native, Runtime = 0x03, Unmanaged = 0x04,
...
public enum Op
{
    nop, breakOp, ldarg_0, ldarg_1, ldarg_2, ldarg_3,
...
internal class ClassLayout : MetaDataElement
{
    ...
    readonly ushort packSize = 0;
    readonly uint classSize = 0;
...
internal class ConstantElem : MetaDataElement
{
    ...
    readonly MetaDataElement parent;
...
public class CustomAttribute : MetaDataElement
{
    ...
    readonly MetaDataElement parent;
    readonly Method type;
    uint valIx;
    readonly Constant cVal;
    readonly byte[] byteVal;
    readonly ushort numNamed = 0;
    ...
    static byte[] ConstantToByteArray(Constant c)
    {
        ...
        if (c is StringConst sc)
        {
            string value = sc.val ?? throw new NotImplementedException();
...
public class PermissionMember
{
    ...
    public PermissionMember(MemberTypes member_type, Type type, string name, object value)
    {
    ...
    {
        return obj is PermissionMember member &&
               name == member.name;
    }
...
public class Permission
{
    ...
    public void AddMember(PermissionMember member)
    {
        members ??= [];
...
{
    readonly SecurityAction sec_action;
    ArrayList permissions;

    public PermissionSet(SecurityAction sec_action)
    {
...
public class FieldMarshal : MetaDataElement
{
    ...
    readonly MetaDataElement field;
    readonly NativeType nt;
    uint ntIx;
...
public class FileRef : MetaDataElement
{
    ...
    readonly uint nameIx = 0, hashIx = 0;
    readonly uint flags = 0;
...
public class ImplMap : MetaDataElement
{
    ...
    uint iNameIx;
    readonly ModuleRef importScope;
...
public class GenericParameter : MetaDataElement
{
    ...
    readonly MetaDataElement owner;
...
internal class GenericParamConstraint : MetaDataElement
{
    ...
    readonly GenericParameter param;
    readonly Type type;
...
internal class MethodSpec : Method
{
    ...
    readonly Method meth;
    readonly GenericMethodSig g_sig;
    uint sidx;
...
public class InterfaceImpl : MetaDataElement
{
    ...
    readonly ClassDef theClass;
    readonly Class theInterface;
...
public class ManifestResource : MetaDataElement
{
    ...
    string mrName;
    readonly MetaDataElement rRef;
    uint fileOffset;
    uint nameIx = 0;
    uint flags = 0;
    readonly byte[] resourceBytes;
...
public class MethodSemantics : MetaDataElement
{
    ...
    readonly Feature.MethodType type;
    readonly MethodDef meth;
    readonly Feature eventOrProp;
...
public class ClassRefInst : Type
{
    ...
    readonly private bool is_value;
...
public class ClassDef : Class
{
    ...
    internal void SetSuper(Class sClass)
    {
        superType = sClass;
        setSuperType = true;
        if (sClass is not GenericTypeInst)
    ...
    /// <param name="name">method name</param>
    /// <param name="ret_param">return type</param>
    /// <param name="pars">parameters</param>
    /// <returns>a descriptor for this new method</returns>
    ...
    /// <param name="retType">property type</param>
    /// <param name="pars">property type</param>
    ...
    public static void AddSecurity(byte[] permissionSet)
    {
...
public class ClassRef : Class, IExternRef, IResolutionScope
{
    ...
    /// <param name="retType">return type</param>
    /// <param name="pars">parameter types</param>
    /// <param name="optPars">parameter types</param>
    /// <returns>a descriptor for this method</returns>
    ...
    {
        if ((parent != null) && (parent is AssemblyRef @ref))
            return (nameSpace + "." + name + ", " + @ref.TypeName());
        else
            return (nameSpace + name);
    }
...
public class GenericTypeInst : Class
{
    ...
    readonly private Type gen_type;
    readonly private Type[] gen_param;
    bool inTable = false;
    uint sigIx = 0;
...
public class MethPtrType : Type
{
    ...
    readonly bool varArgMeth;
    readonly Type retType;
    readonly Type[] parList;
    readonly Type[] optParList;
    readonly CallConv callConv;
    readonly uint numPars;
    readonly uint numOptPars;
    uint sigIx = 0;

    /// <summary>
    /// Create a new function pointer type
    /// </summary>
    /// <param name="callconv">the function to be referenced</param>
    /// <param name="retType">the function to be referenced</param>
    /// <param name="pars">the function to be referenced</param>
    /// <param name="varArgMeth">the function to be referenced</param>
    /// <param name="optPars">the function to be referenced</param>
...
public class BoundArray : Array
{
    ...
    private static void CompressSignedNum(int val, MemoryStream str)
    {
        uint uval = (uint)val;
        byte sign = 0;
        if (val < 0)
...
{
    readonly DataConstant[] dataVals;
...
public class CustomModifiedType : Type
{
    ...
    readonly Type type;
    readonly Class cmodType;
    readonly PrimitiveTypeRef cmodPrimType;
...
public class Feature : MetaDataElement
{
    ...
    {
        Setter = 0x01, Getter, Other = 0x04, AddOn = 0x08,
...
public class MethodDef : Method
{
    ...
    readonly Param[] parList;
    Local[] locals;
    bool initLocals;
    ushort methFlags = 0, implFlags = 0;
    readonly int numPars = 0;
    int maxStack = 0;
    bool entryPoint = false;
    LocalSig localSig;
    ArrayList varArgSigList;
    ImplMap pinvokeImpl;
    readonly Param ret_param;
...
public class MethodRef : Method
{
    ...
    readonly Type[] parList, optParList;
    readonly MetaDataElement parent;
    readonly uint numPars = 0, numOptPars = 0;
    CallConv callConv = CallConv.Default;
    readonly Type retType;
    readonly int gen_param_count;
...
public class NativeArray : NativeType
{
    ...
    readonly int numElem = -1, parNum = -1, elemMult = -1;
...
public class SafeArray : NativeType
{
    ...
    readonly SafeArrayType elemType;
    readonly bool hasElemType;
...
public class CustomMarshaller : NativeType
{
    ...
    readonly string marshallerName;
...
public class PrimitiveType : Type
{
    ...
    readonly private int systemTypeIndex;
    public const int NumSystemTypes = 18;
...
public sealed class MSCorLib : AssemblyRef
{
    ...
    readonly private Class[] systemClasses = new Class[valueTypeIx + 2];
    readonly private PrimitiveType[] systemTypes = new PrimitiveType[valueTypeIx];

    readonly private static int[] specialNames = [
...
public class MetaData
{
    ...
    readonly MetaDataStream strings, us, guid, blob;

    readonly MetaDataStream[] streams = new MetaDataStream[5];
    readonly uint numStreams = 5;
    uint tildeTide = 0, tildePadding = 0, tildeStart = 0;
    uint numTables = 0, resourcesSize = 0;
    readonly ArrayList[] metaDataTables = new ArrayList[numMetaDataTables];
    readonly ArrayList byteCodes = [];
    uint codeSize = 0, codeStart, byteCodePadding = 0, metaDataSize = 0;
    ulong valid = 0;
    readonly ulong sorted = 0; /*sorted = 0x000002003301FA00;*/
    readonly bool[] largeIx = new bool[numMetaDataTables];
    readonly bool[] lgeCIx = new bool[(int)CIx.MaxCIx];
    bool largeStrings = false, largeUS = false, largeGUID = false, largeBlob = false;
    readonly private FileImage file;
    private byte heapSizes = 0;
    MetaDataElement entryPoint;
    BinaryWriter output;
    MSCorLib _mscorlib;
    readonly private TypeSpec[] systemTypeSpecs = new TypeSpec[PrimitiveType.NumSystemTypes];
    long mdStart;
    ...
    public MSCorLib mscorlib
    {
        get
        {
            return _mscorlib ??= new MSCorLib(this);
        }
    }
...
internal class MetaDataStream : BinaryWriter
{
    ...
    private static readonly uint StreamHeaderSize = 8;
    readonly private static uint maxSmlIxSize = 0xFFFF;
    ...
    readonly char[] name;
    readonly Hashtable htable = [];
    [SuppressMessage("", "CS0618", Justification = "TODO: convert to IEqualityComparer")]
    readonly Hashtable btable = new Hashtable(new ByteArrayEqualityComparer());
    readonly bool addInitByte = false;
    ...
    internal MetaDataStream(char[] name, Encoding enc, bool addInitByte) : base(new MemoryStream(), enc)
    {
        this.addInitByte = addInitByte;
        this.name = name;
        sizeOfHeader = StreamHeaderSize + (uint)name.Length;
    ...
    internal static void WriteDetails()
    {
...
class ByteArrayEqualityComparer : IEqualityComparer
{
