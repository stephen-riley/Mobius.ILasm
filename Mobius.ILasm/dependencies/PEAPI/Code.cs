...
namespace PEAPI
{
    ...
    {
        readonly MetaDataElement theType;
    ...
    {
        readonly CILLabel dest;
        readonly private bool shortVer = true;
    ...
    public class CILInstructions
    {
        ...
        public static CILLabel NewLabel()
        {
            return new CILLabel();
        }
    ...
    public class Local
    {
        ...
        readonly Type type;
        readonly bool pinned = false, byref = false;
    ...
    public class CILLabel
    {
        ...
        readonly uint offset = 0;
        readonly bool absolute;
