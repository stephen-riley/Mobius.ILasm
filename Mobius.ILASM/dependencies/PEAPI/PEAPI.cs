...
namespace PEAPI
{
    ...
    internal class FileImage : BinaryWriter
    {
        ...
        private static readonly byte[] DOSHeader = { 0x4d,0x5a,0x90,0x00,0x03,0x00,0x00,0x00,
            ...
            0x50,0x45,0x00,0x00};
        readonly private static byte[] PEHeader = { 0x4c, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        readonly private uint runtimeFlags = 0x01;  // COMIMAGE_FLAGS_ILONLY
        ...
        readonly DateTime origin = new DateTime(1970, 1, 1);
        ...
        MetaData metaData;
        readonly char[] runtimeEngine = runtimeEngineName.ToCharArray();
        char[] hintNameTable;
        ...
        private static void WriteRsrcSection()
        {
            // pass
        }
        ...
        private static void Align(MemoryStream str, int val)
        {
        ...
        private static uint Align(uint val, uint alignVal)
        {
            if ((val % alignVal) != 0)
            {
    ...
    public class PEFile
    {
        ...
        readonly private ArrayList resources = new ArrayList();
        ...
        {
            SetName(name);
            string fname = module_name ?? MakeFileName(outputDir, name, isDLL);
            if (outStream == null)
        ...
        private static string MakeFileName(string dirName, string name, bool isDLL)
        {
            string result = "";
        ...
        /// <param name="nsName">name space name</param>
        /// <param name="name">class name</param>
        /// <param name="vClass">class name</param>
        /// <returns>a descriptor for this new class</returns>
        ...
        public void AddDeclSecurity(SecurityAction sec_action, PermissionSet ps, MetaDataElement element)
        {
        ...
        /// <param name="flags">Access for the resource</param>
    ...
    /// </summary>
    public class PEFileException : Exception
    {
    ...
    public class TypeSignatureException : Exception
    {
