...
namespace Mono.ILASM
{
    ...
    public class ILTokenizer : ITokenStream
    {
        ...
        readonly private static Hashtable keywords;
        readonly private static Hashtable directives;

        readonly private ILToken lastToken;
        readonly private ILReader reader;
        readonly private StringHelper strBuilder;
        readonly private NumberHelper numBuilder;
        ...
        {
            NewTokenEvent?.Invoke(this, new NewTokenEventArgs(token));
        }
    }
}
